...
dev: .env certs/ca-crt.pem certs/es-key.pem certs/certs.db
	cargo run

dev-docker: certs/ca-crt.pem certs/es-key.pem certs/certs.db certs/ca-crl.pem certs/server-crt.pem
	cargo build
	docker compose up
